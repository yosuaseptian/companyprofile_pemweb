...
<html class="no-js"> <!--<![endif]-->
	...
	<header id="fh5co-header" role="banner">
		<div class="container">
			<div class="header-inner">
				<h1><a href="<?php echo base_url().''?>">Kelompok 5<span>.</span></a></h1>
				<nav role="navigation">
					<ul>
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Who We Are</h2>
		   					<p class="fh5co-lead"> Awesome source code by <a href="#" target="_blank">Kelompok 5</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
	...
	<div class="fh5co-about animate-box">
		<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
			<h2>About Us</h2>
			<p>Kelompok 5 merupakan perusahaan yang bergerak dan memfokuskan diri pada bidang Konsultan IT dan Security. Seiring dengan pesatnya perkembangan teknologi dan keterkaitan nya dengan bidang usaha maka kami hadir di dunia teknologi informasi untuk memberikan solusi, perencanaan, dan strategi yang terintegerasi sebagai nilai tambah yang maksimal bagi kebutuhan dan permasalahan dibidang Teknologi Informasi.</p>
		</div>
		<div class="container">
			<div class="col-md-6">
				<figure>
		...
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 fh5co-staff">
						...
						<p>Yosua Septian adalah seorang middle engineer yang sedang berkuliah di Universitas MercuBuana.</p>
					...
					<div class="col-md-4 fh5co-staff">
						...
						<h3>Getsfy Mahardika</h3>
						<h4>Co-Founder, Desaigner</h4>
						<p>Getsfy Mahardika adalah seorang web designer yang sedang berkuliah di Universitas MercuBuana .</p>
						<ul class="fh5co-social">
							<li><a href="#"><i class="icon-google"></i></a></li>
							<li><a href="#"><i class="icon-dribbble"></i></a></li>
							<li><a href="#"><i class="icon-twitter"></i></a></li>
					...
					<div class="col-md-4 fh5co-staff">
						...
						<h3>Mahmud Syaiful Aminudin</h3>
						<h4>Co-Founder, Enginer</h4>
						<p>Mahmud Syaiful Aminudin adalah seorang middle engineer yang sedang berkuliah di Universitas MercuBuana.</p>
						<ul class="fh5co-social">
							<li><a href="#"><i class="icon-google"></i></a></li>
							<li><a href="#"><i class="icon-dribbble"></i></a></li>
							<li><a href="#"><i class="icon-twitter"></i></a></li>
